...
class AppWipeDialogCubit extends Cubit<AppWipeDialogState> {
  final VoidCallback applicationWipedCallback;

  final AppService appService = globalLocator<AppService>();

  AppWipeDialogCubit({
    required this.applicationWipedCallback,
  ...
  Future<void> confirm() async {
    if (state.confirmationsCount < AppWipeDialogState.requiredConfirmationsCount) {
      ...
      emit(state.copyWith(resetInProgressBool: true));

      await appService.wipe();
      applicationWipedCallback();
    }
  }
}
