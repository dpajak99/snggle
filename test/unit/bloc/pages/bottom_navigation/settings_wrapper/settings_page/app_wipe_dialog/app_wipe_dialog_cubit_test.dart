...
void main() {
  ...
  group('Tests of AppWipeDialogCubit process', () {
    ...
    test('Should [emit AppWipeDialogState] with [confirmationsCount == 3], [resetInProgressBool == TRUE] and wipe application', () async {
      // Act
      await actualAppWipeDialogCubit.confirm();
      AppWipeDialogState actualAppWipeDialogState = actualAppWipeDialogCubit.state;
      ...
      // Assert
      AppWipeDialogState expectedAppWipeDialogState = const AppWipeDialogState(confirmationsCount: 3, resetInProgressBool: true);
